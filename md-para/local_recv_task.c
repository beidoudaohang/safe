...
#ifdef TEST_DATA
const u8 key_set_test[47] = {0x48,0x53,0x31,0x2e,0x30,0x23,0x00,0x00,0xff,0xff,0xb7,0x3a,0x01,0x00,0x01,0x00,0x00,0x01,0x30,0x01,0x01,0x80,0x04,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x39,0x00,0x01,0x01,0x00,0xea,0x48,0x45,0x31,0x2e,0x30};
...
void *local_recv_task(void* arg)
{
	...
	while(1){
		...
		memcpy(frame_local_recv.arr, key_read_test, 47);
